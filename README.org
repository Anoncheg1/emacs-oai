![build](https://github.com/Anoncheg1/emacs-oai/workflows/melpazoid/badge.svg)
[![MELPA](https://melpa.org/packages/oai-badge.svg)](http://melpa.org/#/oai)
[![MELPA Stable](https://stable.melpa.org/packages/oai-badge.svg)](https://stable.melpa.org/#/oai)
...
* Screenshot
At left part of screenshot is the main window with chat
 and AI answer. At right part is a help window with
 expanded link.
