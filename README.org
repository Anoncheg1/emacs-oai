[[https://github.com/Anoncheg1/emacs-oai/workflows/melpazoid/badge.svg?event=push]]
[[http://melpa.org/#/oai][file:https://melpa.org/packages/oai-badge.svg]]
[[https://github.com/Anoncheg1/emacs-oai/workflows/melpazoid/badge.svg?event=release]]
...
* Features:
- *Tags* expansion of tags, Org links and noweb references
...
- *Transparency* for inspecting raw data of request
- *Customization* in autofilling, hooks, powerful debugger
...
- org-babel--normalize-body = oai-block--area, oai-block--contents-area
