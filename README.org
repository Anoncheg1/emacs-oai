...
Uses oai-restapi-con-service, service name and model string define all connection informnation.
#+begin_src elisp :lexical t :results none :exports code :eval no
...
(let ((oai-restapi-show-error-function #'oai-restapi--show-error))
  (oai-restapi-request 'github "openai/gpt-4.1"
                       (lambda (result) (oai-restapi--get-single-response-text result))
