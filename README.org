...
- *Parallel request* in the same or different buffer without waiting
- *Highlighting* markdown big blocks, tags and links, headers, bold text, Org tables, LaTeX
- *Transparency* inspect raw data request
- *Customization* Autofilling, hooks, powerful debugger
