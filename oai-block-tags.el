...
NOWEB-CONTEXT is :eval by default, but may be changed.
...
Optional ELEMENT argiment is ai block, SOURCE-BLOCK-MARKER used to
...
Optional SOURCE-BLOCK-MARKER argument used to prevent loop.
Return string."
