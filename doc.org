...
1) ~oai-block-collect-chat-messages-at-point~
...
- oai-restapi--modify-vector-last-user-content
...
- oai-block-tags-get-content-ai-messages -
  ...
  - 1) oai-block-collect-chat-messages-at-point 2) apply noweb and tags.
...
Solution:
1) split oai-block-collect-chat-messages-at-point to get messages and apply noweb and tags (not needed)
